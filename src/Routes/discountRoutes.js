...
import { applyDiscount, createDiscount, createDiscountPartner, deleteDiscount, deleteDiscountPartner, getDiscount, getDiscountPartner, getDiscountUser, selectDiscount, selectDiscountPartner, updateDiscount, updateDiscountPartner } from "../Controllers/discountController.js";
import { checkToken } from "../Config/jwtConfig.js";

const discountRoutes = express.Router();

discountRoutes.get("/get-discount", getDiscount);
discountRoutes.get("/get-discount-user", checkToken, getDiscountUser);
...
discountRoutes.get("/apply-discount/:MA_MGG", checkToken, applyDiscount);
